/*=============== ADD BLUR HEADER ===============*/ const blurHeader = ()=>{
    ...
    if (window.scrollY >= 50) // If blurElement does not exist, create it
    {
        if (!blurElement) {
    ...
    } else // If the scroll position is less than 50 and blurElement exists, remove it
    if (blurElement) header.removeChild(blurElement);
};
// Add an event listener for the scroll event
window.addEventListener("scroll", blurHeader);

//# sourceMappingURL=index.727d9814.js.map
